...
function keyHandler(e) {
	...
	// Traverse up to closest selector (.menu in this case)
	...
	switch(keyCode) {
		case KeysDict.left:
		case KeysDict.up:
			domUtils.getPreviousLink(parentMenuEl, target).focus();
			break;
		case KeysDict.right:
		case KeysDict.down:
			domUtils.getNextLink(parentMenuEl, target).focus();
			break;
		case KeysDict.home:
			domUtils.getLinks(parentMenuEl)[0].focus();
			break;
		case KeysDict.end:
			var links = domUtils.getLinks(parentMenuEl);
