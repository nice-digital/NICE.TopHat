 ...
 */
utils.getPreviousLink = function(containers, currentLink) {
	if(!containers) return;

	var links = utils.getLinks(containers),
 ...
 */
utils.getNextLink = function(containers, currentLink) {
...
utils.getIdsOfControlledElements = function(elId){
...
utils.getControllingElementId = function(element){
    ...
    //If controlling El is disabled then find its parent (controlling) element
