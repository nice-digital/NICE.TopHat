...
module.exports = '<a href="{{root}}/signin" class="menu-anonymous" id="anon-profile">Sign in</a>';
...
function getTophatElement( classname, config ) {
  ...
  if (!el) {
      el = utils.create('<div role="banner" id="tophat-container" class="'+ classname +'"></div>');
  }
...
},{"./config":3,"./cookie":6,"./events":7,"./evidence":10,"./global":11,"./profile":12,"./search":13,"./services":14,"./tophat.css":27,"./utils/dom":29,"./vendor/matchMedia":31}],29:[function(require,module,exports){
var config = require('../config');
