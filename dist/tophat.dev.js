...
var profile = require('./tophat.profile')( tophatElement, config );
...
module.exports = '<div class="nice-profile"><div class="tophat-inner"><ul class="menu">{{menu}}</ul></div></div>';
