...
module.exports = '<div class="nice-evidence" id="nice-evidence"><div class="tophat-inner" role="navigation"><ul class="menu" role="menu" aria-labelledby="evidence-menu" aria-hidden="true" id="evidence-dropdown">{{menu}}</ul></div></div>';
},{}],14:[function(require,module,exports){
module.exports = '<li class="menu-evidence" role="presentation"><a href="#nice-evidence" aria-haspopup="true" id="evidence-menu" role="menuitem" aria-haspopup="true" aria-controls="nice-evidence">Evidence services</a></li>';
...
module.exports = '<div class="nice-profile" id="nice-profile"><div class="tophat-inner" role="navigation"><ul class="menu" role="menu" aria-labelledby="profile-meun" aria-hidden="true" aria-expanded="false">{{menu}}</ul></div></div>';
},{}],19:[function(require,module,exports){
module.exports = '<a href="#nice-profile" class="menu-profile" id="profile-menu" aria-controls="nice-profile" aria-haspopup="true" aria-expanded="false"><span class="profile-avatar"></span></a>';
