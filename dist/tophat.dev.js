...
function generateProfile( el, profile ) {
    ...
    if (profile.thumbnail && profile.thumbnail.length) {
        profileLink.innerHTML = '<img src="'+ profile.thumbnail +'" alt="Your profile image" />';
    }
