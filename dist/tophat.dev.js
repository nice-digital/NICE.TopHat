...
module.exports = '<div class="nice-evidence" id="nice-evidence"><div class="tophat-inner" role="navigation"><ul class="menu" role="menu" aria-labelledby="menu-evidence" aria-hidden="true" id="evidence-dropdown">{{menu}}</ul></div></div>';
},{}],14:[function(require,module,exports){
module.exports = '<li class="menu-evidence" role="presentation"><a href="#nice-evidence" aria-haspopup="true" id="menu-evidence" role="menuitem" aria-controls="evidence-dropdown" aria-expanded="false">Evidence services</a></li>';
...
module.exports = '<li role="menuitem"><a href="{{href}}">{{label}}</a></li>';
},{}],18:[function(require,module,exports){
module.exports = '<div class="nice-profile" id="nice-profile"><div class="tophat-inner" role="navigation"><ul id="profile-dropdown" class="menu" role="menu" aria-labelledby="menu-profile" aria-hidden="true">{{menu}}</ul></div></div>';
},{}],19:[function(require,module,exports){
module.exports = '<a href="#nice-profile" class="menu-profile" id="menu-profile" aria-controls="profile-dropdown" aria-haspopup="true" aria-expanded="false"><span class="profile-avatar"></span></a>';
...
module.exports = '<div class="nice-services" role="navigation"><div class="tophat-inner"><a href="#" class="menu-mobile" id="menu-mobile" aria-controls="main-menu" aria-expanded="false" aria-controls="main-menu" aria-hidden="true">Menu</a> <a href="{{homelink}}" class="logo">NICE <small>National Institute for<br>Health and Care Excellence</small></a><ul class="menu" role="menubar" id="main-menu" aria-labledby="menu-mobile" aria-hidden="false">{{menu}}</ul></div></div>';
