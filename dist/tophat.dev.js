...
module.exports = '<div class="nice-global" id="nice-global"><div class="tophat-inner" role="search"></div></div>';
...
module.exports = '<form class="nice-search" method="{{method}}" action="{{action}}" data-track="search"><div class="controls"><input name="q" value="{{q}}" autocomplete="off" spellcheck="false" placeholder="{{placeholder}}" maxlength="250" data-provide="typeahead" data-source-type="{{typeaheadtype}}" data-source="{{typeaheadsource}}" id="search"> <button type="submit" aria-label="perform-search"><i class="icon-search"></i> <span class="menu-label">Search</span></button></div></form>';
},{}],21:[function(require,module,exports){
module.exports = '<li class="menu-{{id}}" role="presentation"><a href="{{href}}" role="menuitem">{{label}}</a></li>';
},{}],22:[function(require,module,exports){
module.exports = '<nav class="nice-services" role="navigation"><div class="tophat-inner"><a href="#" class="menu-mobile">Menu</a> <a href="{{homelink}}" class="logo">NICE <small>National Institute for<br>Health and Care Excellence</small></a><ul class="menu" role="menubar">{{menu}}</ul></div></nav>';
